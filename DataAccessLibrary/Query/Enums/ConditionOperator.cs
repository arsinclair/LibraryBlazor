namespace DataAccessLibrary.Query
{
    ...
    public enum ConditionOperator
    {
        ...
        /// <summary>
        ///   <para>The value is equal to the specified user ID.</para>
        /// </summary>
        EqualUserId,

        /// <summary>
        ///   <para>The value is not equal to the specified user ID.</para>
        /// </summary>
        NotEqualUserId,

        /// <summary>
        ///   <para>The value is equal to the specified business ID.</para>
        /// </summary>
        EqualBusinessId,

        /// <summary>
        ///   <para>The value is not equal to the specified business ID.</para>
        /// </summary>
        NotEqualBusinessId,
        ...
        /// <summary>
        ///   <para>The value is found in the specified bit-mask value.</para>
        /// </summary>
        Mask,

        /// <summary>
        ///   <para>The value is not found in the specified bit-mask value.</para>
        /// </summary>
        NotMask,

        /// <summary>
        ///   <para>
        ///     For internal use only.</para>
        /// </summary>
        MasksSelect,
