    ...
    public class DatabaseCacheFixture : DatabaseCache, IDisposable
    {
        ...
        private Dictionary<Guid, SysField> PopulateFields()
        {
            return new Dictionary<Guid, SysField>()
            {
                ...
                { Guid.Parse("05D5D701-F18C-4F0A-8422-C783C7F8971E"), new SysField() { Id = Guid.Parse("05D5D701-F18C-4F0A-8422-C783C7F8971E"), ParentEntity = base._Entities[Guid.Parse("A2D89C4D-4DA6-4217-9312-8D6376475A63")], Name = "AlternativeName2", DisplayName = "Alternative Name 2", DatabaseColumnName = "AlternativeName2", Type = base._FieldTypes[Guid.Parse("28252041-6A08-4CD1-8BDF-4BFE5D3153E2")] } },
